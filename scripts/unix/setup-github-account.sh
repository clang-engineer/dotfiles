...
echo "========================================="
"$SCRIPT_DIR/opt/generate-ssh-key.sh" "$USERNAME" "$EMAIL"
...
echo "========================================="
"$SCRIPT_DIR/opt/add-ssh-config.sh" "$USERNAME"

echo ""
echo "========================================="
echo "Step 3: Setup Git includeIf"
echo "========================================="
"$SCRIPT_DIR/opt/setup-git-includeif.sh" "$WORKSPACE_PATH" "$GIT_NAME" "$EMAIL"
