return {
  ...
  -- Vertica: dadbod 기본 어댑터 미지원. vsql 또는 vim-dadbod-vertica 필요.
  -- { name = "[SNUH] Vertica ODS (emr)", url = "vertica://emr@172.26.33.19:5433/CDW" },
  -- { name = "[SNUH] Vertica ODS (rex)", url = "vertica://vertica@172.26.33.19:5433/CDW" },
  -- { name = "[SNUH] Vertica cdwdb",     url = "vertica://rex@cdwdb.snuh.org:80/CDW" },
}
