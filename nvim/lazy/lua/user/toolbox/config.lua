...
local defaults = {
  dir = nil, -- if nil, use the TOOLBOX_DIR environment variable
}
...
function M.warn_no_dir()
  vim.notify(
    "toolbox: dir is not set or the directory does not exist.\n"
      .. "Specify it with setup({ dir = ... }) or set the TOOLBOX_DIR environment variable.",
    vim.log.levels.WARN,
    { title = "toolbox" }
  )
end
